...
export default function HeroSection() {
  return (
    <section className="relative w-full flex items-center overflow-hidden min-h-screen pt-20">
      {/* <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-primary to-green-400 dark:from-blue-900 dark:via-primary dark:to-green-700 opacity-40"></div> */}
            ...
            >
              {menu.social.map((link, index) => (
                <Link
                  ...
                  to={link.url}
                  title={link.name}
                  className="group/social-link hover:text-secondary transition"
                  target="_blank"
...
//                 target="_blank"
//                 rel="noopener"
//                 className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 mt-4"
//               >
//                 Contact US
//               </Link>
//               <a
